...
public class Basic_Func_Test {
	...
	public void beforeMethod() throws MalformedURLException{
		...
		driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
		 ...
		 @Test(priority=1, description="Check Login and SignUp are displayed")
		 public void TC001() {
		  //There is element with name App on screen.
		  //loginSkipbtn will be true.
		  Boolean loginBtn = driver.findElementById("ca.used:id/login_skip_button").isDisplayed();
		  
		  //loginSkipbtn will be true and the assertion will pass.
		  Assert.assertTrue(loginBtn,"Login/Skip button is displayed");
		 ...
		 @Test(priority=2, description="Check Skip button is displayed")
		 public void TC002(){
		//Verify Carousel element skip button is displayed
		...
		System.out.println("Skip button is displayed");
		 ...
		 @Test(priority=3, description="Check indicator icon is displayed")
		 public void TC003(){
		...
		System.out.println("Indicator element is displayed");
		 ...
		 @Test(priority=4, description="Login with FaceBook is displayed and Enabled")
		 public void TC004(){
		...
		System.out.println("Facebook button is enabled");
		 ...
		 @Test(priority=5, description="Verify the text Or is diplayed")
		 public void TC005(){
		...
		//System.out.println(elementOr);
		 ...
		 @Test(priority=6, description="Verify login/email address text can be entered")
		 public void TC006(){
		...
		//login.clear();
		 ...
		 @Test(priority=7, description="Verify Forgot Password is present")
		 public void TC007(){
		 ...
		 @Test(priority=8, description="Verify Sign in button is enabled")
		 public void TC008(){
		 ...
		 @Test(priority=9, description="Verify Clicking skip button takes you to Search by Region")
		public void TC009(){
		 ...
		 @Test(priority=10, description="Verify Search field is enabled")
		public void TC010(){
		 ...
		 @Test(priority=11, description="Enter a province in the Search field.")
			public void TC011(){
		 ...
		 @Test(priority=12, description="Verify province searched for is returned and you can click it.")
			public void TC012(){
		 ...
		 @Test(priority=13, description="Verify Search icon can be clicked and takes you to search screen.")
			public void TC013(){
		 ...
		 @Test(priority=14, description="Verify search query can be entered ie snowboards")
			public void TC014(){
		 ...
		 @Test(priority=15, description="Verify false positive by expecting snowboarding")
			public void TC015(){
		 ...
		 @Test(priority=16, description="Click item search to display item")
			public void TC016(){
